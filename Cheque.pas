...
begin
   ...
   begin
      ...
      BEGIN
          ...
          sSQL := sSQL + 'FROM ';
          sSQL := sSQL + '(SELECT ABS(R.RATE) AS TAX_RATE,  I.NINVOICE, I.ACCT, I.CREDITOR, I.DESCR, I.OWING, I.AMOUNT, I.TAX, I.REFNO, I.NCREDITOR, 0 AS U_AMOUNT, 0 AS U_TAX, T.AMOUNT AS T_AMOUNT, T.TAX AS T_TAX, MAX(R.COMMENCE), T.TAXCODE ';
