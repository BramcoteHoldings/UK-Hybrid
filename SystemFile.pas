...
uses
  ...
  JvExMask, JvToolEdit, JvDBLookup, MemDS, cxNavigator;
...
uses
  AxiomData, UserStatementEditor, MiscFunc, Desktop,glComponentUtil, GenEditor,
  cxRichEdit
  {, GenEditorHTML}
  ;
...
begin
   ...
   grpFeeAlertRec.Properties.Items.Items[0].Caption := getLabelValue('MATTER','PARTNER',imaxLength);
   grpFeeAlertRec.Properties.Items.Items[1].Caption := getLabelValue('MATTER','AUTHOR',imaxLength);
   grpFeeAlertRec.Properties.Items.Items[2].Caption := getLabelValue('MATTER','OPERATOR',imaxLength);
   grpFeeAlertRec.Properties.Items.Items[3].Caption := getLabelValue('MATTER','CONTROLLER',imaxLength);
end;
