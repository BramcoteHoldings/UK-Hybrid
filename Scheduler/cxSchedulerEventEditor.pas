...
{           ExpressScheduler                                         }
{                                                                    }
{           Copyright (c) 2003-2018 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
var
  AStart, AFinish, ATimeDiff: TDateTime;
begin
  inherited;
  ...
  begin
    ...
    begin
    // changed by AES 28/2/2018
//      AStart := AStart + teStart.Time;
      ATimeDiff := teEnd.Time - teStart.Time;
      AFinish := AFinish + (ATimeDiff);
    end;
    Event.Start := AStart;
    Event.Finish := AFinish;
