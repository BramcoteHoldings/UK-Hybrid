...
begin
   try
      ...
      begin
         ...
         begin
            SQL := 'SELECT DISTINCT CODE, NAME AS DESCR, ''N'' AS DEFAULTITEM FROM EMPLOYEE, '+
                   ' FEE WHERE active = ''Y'' AND EMPLOYEE.CODE = FEE.AUTHOR AND FEE.NMEMO = ' + quotedstr(qryBill.FieldByName('NMEMO').AsString) +
                   ' ORDER BY CODE';
