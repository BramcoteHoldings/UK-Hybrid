...
uses
  ...
  IGraph in 'IGraph.pas' {frmInvoiceGraph},
  ...
  MaisterAnalysis in 'MaisterAnalysis.pas' {frmMaisterAnalysis},
  ...
  CheqreqHistoryForm in 'CheqreqHistoryForm.pas' {frmCheqreqHistory},
  ...
  Vcl.Themes,
  Vcl.Styles,
  ArchiveBatch in 'ArchiveBatch.pas' {frmArchiveBatch},
  ...
  ReceiptReqNew in 'ReceiptReqNew.pas' {frmReceiptReqNew},
  ...
  ReceiptReqs in 'ReceiptReqs.pas' {frmReceiptReqs},
  ReceiptReqNarrative in 'ReceiptReqNarrative.pas' {frmReceiptReqNarrative},
