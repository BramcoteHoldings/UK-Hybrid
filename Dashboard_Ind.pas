...
uses
  ...
  dxPScxExtEditorProducers, ppDesignLayer, dxPSTextLnk, dxBarBuiltInMenu, cxNavigator,
...
type
  TfrmDashboard_Ind = class(TForm)
    ...
    ComponentPrinterLink11: TdxGridReportLink;
    ComponentPrinterLink12: TdxGridReportLink;
    ComponentPrinterLink13: TdxGridReportLink;
...
uses AxiomData, Desktop, MiscFunc, DashboardIndDataModule, FeesBilledBreakdown,
     FeesRecBreakdown, Breakdown_WIP, BreakDown_UnbilledWIP;
      ...
      try
         ...
         begin
            ...
            begin
               ...
               State := 2;
               LabelColor := EventLabelColors[dmDashboardInd.qryChargeSummary.FieldByName('eventtype').AsInteger];
...
procedure TfrmDashboard_Ind.tabFeesShow(Sender: TObject);
begin
...
//      Close;
   ...
   with dmDashboardInd.qryFeesReceivedBudgetGraph do
   begin
//      Close;
      ParamByName('author').AsString := EmpCode;
      ParamByName('year_start_date').AsDateTime := LFinDateFirst;
   ...
   with dmDashboardInd.qryFeesReceivedGraph do
   begin
//      Close;
      ParamByName('author').AsString := EmpCode;
      ParamByName('year_start_date').AsDateTime := LFinDateFirst;
   ...
   with dmDashboardInd.qryFeesBilledGraph do
   begin
//      Close;
      ParamByName('author').AsString := EmpCode;
      ParamByName('year_start_date').AsDateTime := LFinDateFirst;
   ...
   with dmDashboardInd.qryFeesBilledBudgetGraph do
   begin
//      Close;
      ParamByName('author').AsString := EmpCode;
      ParamByName('year_start_date').AsDateTime := LFinDateFirst;
...
procedure TfrmDashboard_Ind.cbThreeDClick(Sender: TObject);
var
   bChecked: boolean;
begin
