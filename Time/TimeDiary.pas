...
uses
  ...
  cxStyles, cxEdit, cxScheduler, cxSchedulerStorage,
  ...
  dxPSCore, dxPScxCommon, dxPScxSchedulerLnk, DB, dxBar,
  dxBarExtDBItems, dxBarExtItems, OracleUniProvider, Uni,
  ImgList, MemDS, DBAccess, ActnList, XPStyleActnCtrls, ActnMan,
  cxSchedulerDBStorage, cxCheckBox, cxImage, cxLabel, StdCtrls, cxTextEdit,
  cxMemo, ExtCtrls, cxSchedulerDialogs, DateUtils, ppParameter, ppModule,
  raCodMod, ppVar, ppCtrls, ppBands, ppMemo, ppStrtch, ppRegion, ppPrnabl,
  ...
  cxSchedulerYearView, cxSchedulerGanttView, dxPSPDFExportCore,
  dxPSPDFExport, cxDrawTextUtils, dxPSPrVwStd, dxPSPrVwAdv, dxPSPrVwRibbon,
  dxPScxPageControlProducer, dxPScxGridLnk, dxPScxGridLayoutViewLnk,
  dxPSDBTCLnk, dxPSTextLnk, dxPScxDBEditorLnks, dxPScxEditorProducers,
  dxPScxExtEditorProducers, cxClasses, ppDesignLayer, System.Actions,
  cxBarEditItem, ppTypes, cxSchedulerAgendaView, cxSchedulerRecurrence,
  dxBarBuiltInMenu, cxSchedulerRibbonStyleEventEditor,
  cxSchedulerTreeListBrowser, dxSkinsCore, dxDPIAwareUtils, dxPScxEditorLnks,
  System.ImageList;
