object frmReceiptReqs: TfrmReceiptReqs
  Left = 512
  Top = 223
  ...
  object dbgrReceiptReq: TcxGrid
    ...
    object tvReceiptReq: TcxGridDBTableView
      PopupMenu = popGrid
      OnKeyDown = tvReceiptReqKeyDown
      Navigator.Buttons.CustomButtons = <>
      OnCanSelectRecord = tvReceiptReqCanSelectRecord
      OnFocusedRecordChanged = tvReceiptReqFocusedRecordChanged
      ...
      object tvReceiptReqFILEID: TcxGridDBColumn
        Caption = 'Matter'
      ...
      object tvReceiptReqSHORTDESCR: TcxGridDBColumn
      ...
      object tvReceiptReqTITLE: TcxGridDBColumn
        Caption = 'Client Name'
      ...
      object tvReceiptReqDESCR: TcxGridDBColumn
        Caption = 'Description'
      ...
      object tvReceiptReqCREFNO: TcxGridDBColumn
        Caption = 'Department'
      ...
      object tvReceiptReqCREATED: TcxGridDBColumn
        Caption = 'Date'
        DataBinding.FieldName = 'EXP_DATE'
      ...
      object tvReceiptReqAMOUNT: TcxGridDBColumn
        Caption = 'Amount'
        DataBinding.FieldName = 'AMOUNT'
        PropertiesClassName = 'TcxCurrencyEditProperties'
      end
    end
    object dbgrReceiptReqLevel1: TcxGridLevel
      GridView = tvReceiptReq
    end
  end
  object Panel1: TPanel
    ...
    object rbPreparing: TcxRadioButton
      Left = 558
      Top = 11
      Width = 85
      Height = 21
    ...
    object rbAwaitingAuthorisation: TcxRadioButton
      Left = 670
      Top = 11
      Width = 155
      Height = 21
    ...
    object rbAuthorised: TcxRadioButton
      Left = 852
      Top = 11
      Width = 85
      Height = 21
    ...
    object dtSince: TcxDateEdit
      Left = 1007
      Top = 9
      Properties.DisplayFormat = 'dd-mmm-yyyy'
      Properties.EditFormat = 'dd-mmm-yyyy'
      Properties.OnChange = dtSincePropertiesChange
      TabOrder = 6
      Width = 138
    end
    ...
    object cmbEmployees: TcxLookupComboBox
      Left = 72
      Top = 9
      ...
      Properties.OnCloseUp = cmbEmployeesPropertiesCloseUp
      TabOrder = 9
      Width = 172
    end
  end
  object dsReceiptReqs: TUniDataSource
    AutoEdit = False
    DataSet = qryReceiptReqs
    Left = 188
    Top = 435
  end
  object qryReceiptReqs: TUniQuery
    SQLInsert.Strings = (
      'INSERT INTO CHEQREQ'
    ...
    SQL.Strings = (
        ...
        'SELECT c.trust, c.fileid, c.nmatter, c.amount, c.payor, c.exp_da' +
        'te, c.descr,'
      ...
      'and TRUNC (c.exp_date) >= :p_datefrom'
      '     AND c.amount > 0')
    CachedUpdates = True
    Left = 90
    Top = 443
