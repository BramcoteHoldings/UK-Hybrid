object frmUnbilledWIP: TfrmUnbilledWIP
  Left = 392
  Top = 40
  ...
  object grdAged: TcxGrid
    ...
    object tvFeesBilled: TcxGridDBTableView
      ...
      object tvFeesBilledAMOUNT: TcxGridDBColumn
        ...
        MinWidth = 23
        Styles.Content = dmAxiom.UnreadStyle
        Styles.Footer = dmAxiom.UnreadStyle
        Styles.Header = dmAxiom.UnreadStyle
        Width = 67
      end
  ...
  object qryDebtorLockup: TUniQuery
    ...
    SQL.Strings = (
      ...
      '   ('
        ...
        '--      SELECT a.created, a.descr, a.payer,  a.client_name, a.ma' +
        'tter_desc, a.fileid,(nvl(a.amount, 0) + nvl(a.tax,0)) as amt'
      '--      FROM alloc a, matter'
      ...
      '--      UNION ALL'
        ...
        '      SELECT nmemo.dispatched as created,nmemo.refno as descr, n' +
        'memo.BILL_TO as payer, matter.title as client_name, '
      '      matter.shortdescr as matter_desc, nmemo.fileid, '
      '      (nvl(owing,0)) as amt'
      '      FROM nmemo, matter'
