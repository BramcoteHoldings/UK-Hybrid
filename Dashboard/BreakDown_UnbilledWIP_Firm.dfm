object frmUnbilledWIPFirm: TfrmUnbilledWIPFirm
  ...
  object qryDebtorLockup: TUniQuery
    ...
    SQL.Strings = (
      ...
      '--      UNION ALL'
        ...
        '      SELECT nmemo.dispatched as created, nmemo.refno as descr, ' +
        'nmemo.BILL_TO as payer,matter.title as client_name, shortdescr a' +
        's matter_desc, nmemo.fileid, '
      '      (nvl(owing,0)) as amt'
      '      FROM nmemo, matter'
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object prnLink: TdxGridReportLink
      ...
      ReportDocument.CreationDate = 43147.448892280100000000
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
