...
uses
  ...
  dxDateRanges, cxDBData, cxCurrencyEdit, cxCheckBox, dxPSGlbl, dxPSUtl,
  ...
  dxPScxExtEditorProducers, dxPScxCommon, dxPSCore, dxPSContainerLnk,
  ppParameter, ppDesignLayer, ppBands, ppCache, ppClass, ppComm, ppRelatv,
  ppProd, ppReport, dxBar, cxBarEditItem, dxBarExtItems, cxClasses, cxLabel,
  cxGridLevel, cxGridCustomTableView, cxGridTableView, cxGridDBTableView,
  cxGridCustomView, cxGrid, VCLTee.Series, VCLTee.TeEngine, VCLTee.TeeProcs,
  VCLTee.Chart, VCLTee.DBChart, cxDBLabel, Vcl.StdCtrls, Vcl.ExtCtrls, cxPC,
  DateUtils;
