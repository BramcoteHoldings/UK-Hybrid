...
uses
  ...
  StdCtrls, Grids, DBGrids, ComCtrls, Db, Buttons, Ora, OracleUniProvider, Uni, DBAccess, MemDS, MemDS, DBAccess;
...
begin
  ...
  begin
    SQL := 'SELECT CODE, DESCR FROM WORKFLOWTYPE ORDER BY CODE';
